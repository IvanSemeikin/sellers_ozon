...
col1.table(table_sales.style.set_table_styles([{'selector': 'table', 'props': [('max-width', '1000px')]}]))
col2.table(table_revenue.style.set_table_styles([{'selector': 'table', 'props': [('max-width', '1000px')]}]))
